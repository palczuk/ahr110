...
const i18n = {
  pt: {
    ...
    'cycle.evaporator.name': 'Evaporador', 'cycle.evaporator.short': 'vapor frio · baixa', 'cycle.evaporator.role': 'Lado de baixa pressão',
    ...
    'cycle.compressor.name': 'Compressor', 'cycle.compressor.short': 'azul entra · vermelho sai', 'cycle.compressor.role': 'Transição de baixa para alta',
    ...
    'cycle.condenser.name': 'Condensador', 'cycle.condenser.short': 'rejeita o calor', 'cycle.condenser.role': 'Lado de alta pressão',
    ...
    'cycle.valve.name': 'Expansão', 'cycle.valve.short': 'reduz a pressão', 'cycle.valve.role': 'Transição de alta para baixa',
  ...
  en: {
    ...
    'cycle.evaporator.name': 'Evaporator', 'cycle.evaporator.short': 'cold vapor · low side', 'cycle.evaporator.role': 'Low-pressure side',
    ...
    'cycle.compressor.name': 'Compressor', 'cycle.compressor.short': 'blue in · red out', 'cycle.compressor.role': 'Low-to-high transition',
    ...
    'cycle.condenser.name': 'Condenser', 'cycle.condenser.short': 'rejects heat', 'cycle.condenser.role': 'High-pressure side',
    ...
    'cycle.valve.name': 'Expansion', 'cycle.valve.short': 'drops pressure', 'cycle.valve.role': 'High-to-low transition',
